...
from app.schemas.account import AccountResponse, AccountUpdate, ChangePasswordRequest
...
async def change_password(
    ...
    if not verify_password(request.current_password, current_account.password):
        raise HTTPException(
    ...
    # Update password
    current_account.password = get_password_hash(request.new_password)
    await db.commit()
